...
namespace WebApplication1.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Edit(string id)
        {
            ...
            TempData["ImagePath"] = userFromDb.Photo;
            if (userFromDb != null)
            {
        ...
        public async Task<ActionResult> Edit(ApplicationUser model , HttpPostedFileBase upload)
        {
            ...
            var userFromDb = await _db.Users.FirstOrDefaultAsync(u => u.Id == model.Id);
            if (userFromDb == null)
            {
                return HttpNotFound();
            }
            else
            {
                if (ModelState.IsValid)
                {
                    try
                    {
                        ...
                        {
                            userFromDb.Photo = TempData["ImagePath"].ToString();
                        }
                    }
                    catch (Exception)
                    {
